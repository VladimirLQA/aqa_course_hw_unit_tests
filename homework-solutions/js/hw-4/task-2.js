...
Работа с оператором IF:
  ...
  */
  ...
  if (typeof age !== "number") {
    ...
    console.log("You don't have access cause your age is " + age + " age" + " It's less then "+ minAge)
...
// для 60 выдает ответ "Technical work" но если изменить условие задачи, чтобы 60 было включено в разрешенный возраст и тогда код на 25 строке переписать на else if (age >= minAge && age <= maxAge), тогда вответе будет Welcome Настя!
